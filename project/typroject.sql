...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2924915125ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=typroject&table=user">`typroject`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=typroject&table=orders">`typroject`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pizza_db&table=orders">`pizza_db`.`orders`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="346936625f22337d2e3f7d4879574b6b">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="typroject" targettable="orders">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pizza_db" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="pizza_db" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `orders` DROP `Time`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="typroject" targettable="orders">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `orders` DROP `Time`;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="typroject" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
