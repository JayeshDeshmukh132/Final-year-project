...
<?php 
   ...
   <div class="flex-btn">
      <input type="submit" value="update product" class="option-btn" name="update_product">
      <a href="admin_product.php" class="delete-btn">go back</a>
   </div>
</form>
...
<?php
      ...
      echo '<p class="box">no product found!</p>';
   }
?>
